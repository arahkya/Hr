...
public class UpdatePersonContactTest : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> webApplicationFactory;

    public UpdatePersonContactTest(WebApplicationFactory<Program> webApplicationFactory)
    {

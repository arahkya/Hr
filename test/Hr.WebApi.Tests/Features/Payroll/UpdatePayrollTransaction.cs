...
public class UpdatePayrollTransaction : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> webApplicationFactory;

    public UpdatePayrollTransaction(WebApplicationFactory<Program> webApplicationFactory)
    {

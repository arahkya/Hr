...
public class CreatePayrollTransaction : IClassFixture<WebApplicationFactory<Program>>
{
    private readonly WebApplicationFactory<Program> webApplicationFactory;

    public CreatePayrollTransaction(WebApplicationFactory<Program> webApplicationFactory)
    {
